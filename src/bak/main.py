...
if aquery.count()==0:
  ...
  # live site   
   college = College(name ="Taylor University", address= "236 W Reade Ave Upland, IN", lat =40.459252, lng=-85.497146, appId="573350249394078",appSecret="3a3831b1880fefa721efcc520bceebd9")   
...
Please go to URL if you want to join this ride.
...
If you are able to take this person in your car, please go to URL
...
""" % (passengerName,ride.start_point_title,ride.destination_title,ride.ToD)
        ...
        if choice != "facebook":
          ...
          #commented out to stop spamming Luther College Rideshare
          #384432155015556
          #CAAIJdYHyb54BADKQnUbg9oDTQw5TYgZC63vYo5fdexZCMk79H3chUOOWJ3AGTsP7EBOzBsOvbdZBlY3LY1a9gZAveAsDJUOxd5kS1VlK2SMSf5O48seKw0a8W60xTLGIojJK0GTYXI24f3mUVIHbePgIh5NNZAZBgZD
          #pageGraph = facebook.GraphAPI("CAAIJdYHyb54BADKQnUbg9oDTQw5TYgZC63vYo5fdexZCMk79H3chUOOWJ3AGTsP7EBOzBsOvbdZBlY3LY1a9gZAveAsDJUOxd5kS1VlK2SMSf5O48seKw0a8W60xTLGIojJK0GTYXI24f3mUVIHbePgIh5NNZAZBgZD")
          #pageGraph.put_object("384432155015556","feed",message=body)
